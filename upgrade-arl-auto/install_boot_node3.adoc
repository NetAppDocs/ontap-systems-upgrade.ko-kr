...
.다음 단계
* FC 또는 UTA/UTA2 구성이 있는 시스템이 있는 경우link:set_fc_or_uta_uta2_config_on_node3.html["node3에 FC 또는 UTA/UTA2 구성을 설정합니다."] .
* FC 또는 UTA/UTA2 구성이 없는 경우link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["node1 디스크를 node3에 다시 할당합니다."] 이렇게 하면 node3이 node1의 디스크를 인식할 수 있습니다.
* MetroCluster 구성이 있는 경우link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["node1 디스크를 node3에 다시 할당합니다."] .
