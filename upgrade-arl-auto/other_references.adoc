...
| link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-app-9151/index.html["ONTAP 9.15.1 이상에 도입된 컨트롤러 하드웨어로 업그레이드하려면 "system controller replace" 명령을 사용하십시오"^] | 이 문서에서는 "system controller replace" 명령을 사용하여 ONTAP 9.15.1 이상 버전에 도입된 컨트롤러로 중단 없이 업그레이드하는 데 필요한 애그리게이트 재배치 절차를 설명합니다. 
