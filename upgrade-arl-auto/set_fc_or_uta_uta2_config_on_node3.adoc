...
. 다음 작업 중 하나를 수행합니다.
+
** 노드3에 UTA/UTA2 카드 또는 UTA/UTA2 온보드 포트가 있는 경우 <<check-config-uta-uta2-node3,노드 3의 UTA/UTA2 포트를 확인하고 구성합니다>>로 이동하십시오.
** 노드3에 UTA/UTA2 카드 또는 UTA/UTA2 온보드 포트가 없는 경우 <<check-config-uta-uta2-node3,노드 3의 UTA/UTA2 포트를 확인하고 구성합니다>>을(를) 건너뛰고 link:reassign-node1-disks-to-node3.html["노드1 디스크를 노드3에 재할당합니다"](으)로 이동하십시오.
