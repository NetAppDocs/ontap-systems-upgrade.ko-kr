...
summary: 노드 4에 온보드 FC 포트, UTA/UTA2 포트 또는 UTA/UTA2 카드가 있는 경우, 나머지 절차를 완료하기 전에 설정을 구성해야 합니다. 
---
