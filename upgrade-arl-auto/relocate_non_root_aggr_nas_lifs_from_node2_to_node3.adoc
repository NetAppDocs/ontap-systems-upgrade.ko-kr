...
summary: '"시스템 컨트롤러 교체" 명령을 사용하여 ONTAP 9.5를 실행하는 컨트롤러를 9.7로 업그레이드할 때 node2의 비루트 애그리게이트를 node3으로 재배치합니다.' 
---
...
+
'network port ifgrp show -node_node2_-ifgrp_ifgrp_name_-instance'
