...
link:other-references.html["참조"]를 참조하여 ONTAP의 새로운 28자 라이선스 키를 얻을 수 있는 _NetApp Support Site_에 연결하십시오. 라이선스 키는 _내 지원_ 섹션의 _소프트웨어 라이선스_에서 확인할 수 있습니다. 사이트에 필요한 라이선스 키가 없는 경우 NetApp 영업 담당자에게 문의하십시오.
