...
[role="lead"]
이제 교체 모듈이 포함된 Node1을 부팅할 준비가 되었습니다.  지원되는 교체 모듈은 다음에 나열되어 있습니다.link:decide_to_use_the_aggregate_relocation_guide.html#supported-systems-in-chassis["지원되는 시스템 매트릭스"] .
