...
summary: 필요한 경우, ARL을 사용하여 동일한 섀시에서 컨트롤러 모델을 업그레이드할 때 NVE 또는 NAE에 대해 새 컨트롤러 모듈을 구성합니다. 
---
...
.다음 단계
새 컨트롤러 모듈에서 NetApp Volume 또는 Aggregate Encryption을 설정한 후 link:decommission-old-system.html["기존 시스템을 폐기합니다"].
