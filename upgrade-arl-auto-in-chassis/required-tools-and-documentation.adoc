...
link:other-references.html["참조"]을 참조하여 이 업그레이드에 필요한 참조 문서 및 참조 사이트 목록에 액세스하십시오.

.다음 단계
필요한 도구와 문서를 검토한 후 link:guidelines-for-upgrading-controllers-with-arl.html["컨트롤러 업그레이드 지침에 대해 알아보십시오"].
