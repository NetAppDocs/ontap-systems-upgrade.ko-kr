...
+
다음 자료는 올바른 케이블 연결 방법을 안내합니다. link:other-references.html["참조"]로 이동하여 링크를 확인하십시오.
...
+
절차 초반에 기록해 둔 암호와 백업 정보를 입력하십시오. link:manage_authentication_okm.html["Onboard Key Manager를 사용하여 인증 키를 관리합니다"]을 참조하십시오.
...
.다음 단계
node3를 설치하고 부팅한 후 link:set_fc_uta_uta2_config_node3.html["node3에 FC 또는 UTA/UTA2 구성을 설정합니다."].
