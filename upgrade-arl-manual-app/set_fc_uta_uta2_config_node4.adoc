...
summary: ONTAP 9.8 이상 버전을 실행하는 컨트롤러에서 수동 ARL 업그레이드 중에 노드4 온보드 FC 포트, UTA 및 UTA2 포트 또는 UTA 및 UTA2 카드를 구성합니다. 
---
...
.다음 단계
노드4에서 FC 또는 UTA/UTA2 구성을 설정한 후link:map_ports_node2_node4.html["node2에서 node4로 포트 매핑"].
