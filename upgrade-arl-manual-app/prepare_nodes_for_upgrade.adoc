...
+
 `network interface revert` 명령에 대한 자세한 내용은 link:other_references.html["참조"]를 참조하여 _ONTAP 9 Command reference_에 연결하십시오.
...
+
원격 관리 장치(이 경우 SP)의 네트워크 매개변수를 기존 시스템에서 새 노드의 SP에 재사용할 수 있습니다. SP에 대한 자세한 내용은 link:other_references.html["참조"]를 참조하여 _System Administration Reference_ 및 _ONTAP 9 Command reference_에 연결하십시오.
...
+
AutoSupport에 대한 자세한 내용은 link:other_references.html["참조"]를 참조하여 _System Administration Reference_ 및 _ONTAP 9 Command reference_에 연결하십시오.
