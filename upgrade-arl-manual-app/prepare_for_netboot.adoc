...
* link:other-references.html["참조"]를 참조하여 _NetApp Support Site_ 에 링크하고 사용 중인 플랫폼과 올바른 버전의 ONTAP에 필요한 시스템 파일을 다운로드하십시오.
...
.다음 단계
네트워크 부팅 준비를 마친 후link:relocate_non_root_aggr_node1_node2.html["루트가 아닌 애그리게이트를 node1에서 node2로 재배치합니다"].
