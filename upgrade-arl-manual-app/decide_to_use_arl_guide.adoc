...
link:other-references.html["참조"]를 참조하여 ONTAP 9 제품 설명서에 액세스할 수 있는 _ONTAP 9 Documentation Center_ 링크를 확인하십시오.
...
.다음 단계
이 ARL 절차를 사용할지 여부를 결정한 후link:arl_upgrade_workflow.html["ARL 업그레이드 워크플로를 검토하십시오"].
