...
+
link:other_references.html["참조"]로 이동하여 SP에 대한 정보는 _System Administration Reference_를 참조하고  `system service- processor network modify` 명령에 대한 자세한 정보는 _ONTAP 9 Command reference_를 참조하십시오.
