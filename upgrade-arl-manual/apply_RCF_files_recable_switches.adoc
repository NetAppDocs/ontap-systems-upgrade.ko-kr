...
.시작하기 전에
RCF를 사용하려면 FC 스위치 포트 사용 방식이 _Fabric-attached MetroCluster Installation and Configuration_ 콘텐츠에 설명된 사용 방식과 일치해야 합니다. link:other-references.html["참조"]로 이동하여 _Fabric-attached MetroCluster Installation and Configuration_ 콘텐츠 링크를 참조하십시오.
