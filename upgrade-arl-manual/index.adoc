...
* 이 절차는 ONTAP 9.5 이하 버전을 실행하는 MetroCluster 4노드 및 8노드 구성에 적용됩니다. ONTAP 9.6 이상 버전을 실행하는 MetroCluster 구성의 경우, link:other-references.html["참조"]로 이동하여 _"system controller replace" 명령을 사용하여 ONTAP 9.5에서 ONTAP 9.7로 컨트롤러 하드웨어 업그레이드_를 참조하십시오.
