...
+
자세한 내용은 link:other_references.html["참조"]를 참조하여 _Network Management_ 또는 _ONTAP 9 Command reference_에 연결하고 _Configuring failover settings on a LIF_로 이동하십시오.
