...
summary: 1단계 사전 점검 중에 업그레이드를 위해 노드를 준비하고 일련의 사전 점검을 실행해야 합니다. 
---
= 업그레이드할 노드를 준비합니다
:hardbreaks:
:nofooter: 
...
|===
. 컨트롤러 교체 작업이 시작되고 사전 점검을 완료한 후 작업이 일시 중지되어 나중에 컨트롤러 업그레이드 프로세스에서 필요할 수 있는 출력 정보를 수집할 수 있습니다.
