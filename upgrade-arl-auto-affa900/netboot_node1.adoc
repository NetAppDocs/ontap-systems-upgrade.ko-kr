...
. (AFF A250 및 AFF C250 업그레이드만 해당) 교체 컨트롤러 모듈의 노드1이 부팅되면 다음 경고가 표시됩니다.
+
[listing]
----
*****************************************************
...
+
이 경고는 구성에 기존 컨트롤러에 대한 노드 2가 포함되어 있기 때문에 표시됩니다. 노드2를 업그레이드할 때까지 모든 시스템 부팅에 대해 표시됩니다. 이는 정상적인 동작입니다.
