...
+
"path_to_the_web-Accessible_directory"는 에서 "ONTAP_version_image.tgz"를 다운로드한 위치로 이어져야 합니다 ,2단계.
...
+
노드 2의 노드 show-node_node2_ 명령 출력에서 node2 시스템 ID를 확인할 수 있습니다.
