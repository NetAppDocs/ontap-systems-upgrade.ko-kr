...
. 부팅 메뉴에서 노드가 중지됩니다. "22/7"을 입력하고 숨겨진 옵션 "boot_after_controller_replacement"를 선택합니다. AFF A700 또는 FAS9000 노드 1 디스크를 AFF A900 또는 FAS9500 노드 1에 재할당하려면 프롬프트에서 노드 2의 실제 노드 이름을 입력합니다. 다음 예제를 참조하십시오.
+
[listing]
----
