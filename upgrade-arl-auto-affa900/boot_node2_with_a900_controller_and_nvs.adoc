...
summary: AFF A900 컨트롤러 모듈 및 NVS로 노드 2를 부팅합니다. 
---
...
[role="lead"]
AFF A900 컨트롤러 모듈 및 NVS를 사용하는 node2를 업그레이드할 준비가 되었습니다. 컨트롤러 모듈과 NVS를 교체하여 AFF A700에서 AFF A900으로 업그레이드하려면 콘솔 및 관리 연결만 이동합니다. 이 섹션에서는 AFF A900 컨트롤러 모듈 및 NVS로 노드 2를 부팅하는 데 필요한 단계를 제공합니다.
