...
summary: 'ONTAP 9.15.1 이상에 도입된 컨트롤러 업그레이드 절차가  `system controller replace` 명령을 사용하여 어떻게 작동하는지 이해합니다.' 
---
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["2개"]link:relocate_non_root_aggr_nas_data_lifs_node1_node2.html["2단계. 노드1을 재배치하거나 폐기합니다"]
[role="quick-margin-para"]
...
.다음 단계
ARL 업그레이드 순서에 대해 알게 된 후link:prepare_nodes_for_upgrade.html["업그레이드를 위해 노드를 준비합니다"].
