...
summary: 'ONTAP 9.15.1 이상 버전에 도입된 컨트롤러로 업그레이드할 때는  `system controller replace` 명령을 사용하여 node2와의 HA 쌍을 비활성화하고 node1을 종료하십시오.' 
---
= 노드1을 폐기합니다
:hardbreaks:
:allow-uri-read: 
...
.다음 단계
node1을 폐기한 후 link:prepare_for_netboot.html["netboot 준비"].
