...
+
절차 초반에 기록해 둔 암호와 백업 정보를 입력하십시오. link:manage_storage_encryption_using_okm.html["Onboard Key Manager를 사용하여 스토리지 암호화를 관리합니다"]을 참조하십시오.
...
. [[auto_check_4_step27]] LOADER 프롬프트에서 부팅합니다.
+
`boot_ontap menu`
