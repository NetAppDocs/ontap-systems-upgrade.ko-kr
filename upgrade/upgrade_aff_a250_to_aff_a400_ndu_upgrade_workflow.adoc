...
[role="lead"]
AFF A250 노드를 NS224 드라이브 셸프로 변환하여 AFF A250 시스템에서 AFF A400 시스템으로 무중단 업그레이드를 수행합니다. 그런 다음 AFF A400 교체 노드에 연결합니다. 이렇게 하면 AFF A250 온보드 스토리지가 AFF A400 교체 시스템으로 이동됩니다.
