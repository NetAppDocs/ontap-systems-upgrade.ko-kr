...
summary: AFF A150, AFF A220 또는 FAS2820 node2를 드라이브 셸프로 변환하고 node4에 연결한 후에는 이전에 node2에 속했던 드라이브를 node4에 다시 할당해야 합니다. 
---
...
[role="lead"]
이전에 AFF A150, AFF A220 또는 FAS2820 node2에 속했던 드라이브를 node4로 재할당합니다.
