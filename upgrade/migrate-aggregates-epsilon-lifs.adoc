...
[role="lead"]
AFF A150, AFF A220 또는 FAS2820 node1의 데이터 애그리게이트, epsilon 및 논리 인터페이스(LIF)를 node4로 마이그레이션합니다.
...
.다음 단계
link:convert-node1-to-drive-shelf.html["노드 1을 드라이브 쉘프로 변환한 후 노드 3에 연결합니다"]
