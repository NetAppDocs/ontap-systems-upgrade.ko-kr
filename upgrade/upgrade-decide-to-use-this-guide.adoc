...
.관련 정보
* link:upgrade_aff_a250_to_aff_a400_ndu_upgrade_workflow.html["AFF A250을 드라이브 셸프로 변환하고 스토리지를 AFF A400으로 이동하는 방법에 대해 알아보십시오"] (무중단 절차)
* link:convert-to-drive-shelf.html["드라이브 셸프로 변환하여 AFF A150, AFF A220 또는 FAS2820에서 업그레이드"] (무중단 절차)
