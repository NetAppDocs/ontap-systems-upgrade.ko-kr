...
summary: '업그레이드를 완료하려면 node3을 node4에 연결한 다음 node4의 데이터 논리 인터페이스(LIF)와 데이터 애그리게이트를 node3으로 마이그레이션하십시오.' 
---
...
[role="lead"]
업그레이드를 완료하려면 node3을 node4에 연결한 다음 node4의 데이터 논리 인터페이스(LIF)와 데이터 애그리게이트를 node3으로 마이그레이션하십시오.
