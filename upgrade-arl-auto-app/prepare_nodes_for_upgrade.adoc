...
summary: '"system controller replace" 명령을 사용하여 ONTAP 9.8 이상을 실행하는 컨트롤러를 업그레이드할 때 노드를 준비하고 일련의 사전 점검을 실행합니다.' 
---
= 업그레이드할 노드를 준비합니다
:hardbreaks:
:allow-uri-read: 
...
** 'system node show-instance-node_name'입니다
** 'run-node <node_name> sysconfig'
** 'Storage aggregate show-node_name'입니다
