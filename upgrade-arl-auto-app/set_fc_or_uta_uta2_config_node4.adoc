...
그러나 V-Series 시스템이거나 FlexArray 가상화 소프트웨어가 스토리지 어레이에 연결되어 있고 노드 4에 온보드 FC 포트, 온보드 UTA/UTA2 포트 또는 UTA/UTA2 카드가 없는 경우 node4_로 돌아가서 절차를 재개해야 합니다.link:install_boot_node4.html#step22["22단계"]
...
** node4 에서 UTA/UTA2 포트를 skip_check 및 구성합니다. node4에 UTA/UTA2 카드 또는 UTA/UTA2 온보드 포트가 없는 경우 _Install 및 node4_로 돌아가서 에서 절차를 재개합니다.link:install_boot_node4.html#auto_install4_step23["23단계"]
