...
+
FC 또는 UTA/UTA2 구성이 없는 경우 노드 3에서 노드 1의 디스크를 인식할 수 있도록 수행하십시오.link:reassign-node2-disks-to-node4.html#reassign-node1-node3-app-step1["노드1 디스크를 노드3, 1단계에 재할당합니다"]
