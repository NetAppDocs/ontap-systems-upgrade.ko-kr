...
.다음 단계
* FC 또는 UTA/UTA2 구성이 있는 경우link:set_fc_or_uta_uta2_config_node4.html["노드4에서 FC 또는 UTA/UTA2 포트를 설정하고 구성합니다."] .
* FC 또는 UTA/UTA2 구성이 없는 경우link:reassign-node2-disks-to-node4.html#reassign-node2-node4-app-step1["노드2 디스크를 노드4로 재할당, 1단계"] 이렇게 하면 node4가 node2의 디스크를 인식할 수 있습니다.
* MetroCluster 구성이 있는 경우link:set_fc_or_uta_uta2_config_node4.html["노드4에서 FC 또는 UTA/UTA2 포트를 설정하고 구성합니다."] 노드에 연결된 디스크를 감지합니다.
