...
+
FC 또는 UTA/UTA2 구성을 사용하지 않는 경우, 를 실행합니다 link:set_fc_or_uta_uta2_config_node4.html#auto_check_4_step15["노드 4, 15단계에서 UTA/UTA2 포트를 확인하고 구성합니다"] node4가 node2의 디스크를 인식할 수 있도록 합니다.
