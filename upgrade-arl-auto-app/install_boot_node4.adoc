...
+
FC 또는 UTA/UTA2 구성이 없는 경우 노드 4에서 노드 2의 디스크를 인식할 수 있도록 사전 폼을 link:reassign-node2-disks-to-node4.html#reassign-node2-node4-app-step1["노드2 디스크를 노드4, 1단계에 재할당합니다"]만듭니다.
