...
summary: 이 문서에서는 HA 쌍의 스토리지 컨트롤러를 새 컨트롤러로 업그레이드하는 방법에 대해 설명합니다. 
---
...
^1^ AFF A800 시스템에 필요한 추가 단계를 보려면 섹션에서 A800을 참조하는 단계로 이동하십시오 link:set_fc_or_uta_uta2_config_on_node3.html#step23["노드3, 23단계에서 UTA/UTA2 포트를 확인하고 구성합니다"], 또는 .
